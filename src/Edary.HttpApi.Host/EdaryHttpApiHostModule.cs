...
using Edary.MultiTenancy;
using Edary.HealthChecks;
...
public class EdaryHttpApiHostModule : AbpModule
{
    ...
    private void ConfigureConventionalControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(EdaryApplicationModule).Assembly);
        });
    }
    ...
    private static void ConfigureSwagger(ServiceConfigurationContext context, IConfiguration configuration)
    {
        context.Services.AddAbpSwaggerGenWithOidc(
            ...
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "Edary API", Version = "v1" });
